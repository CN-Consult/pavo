 ...
 */
class ReloadWindowsEventProcessor extends WebClientEventProcessor
{
    /**
     * ReloadWindowsEventProcessor constructor.
     *
    ...
    {
        super(_socket, _pavoApi, [ "reloadWindows" ]);
    }
    ...
    processWebClientEvent(_eventName, _data)
    {
        ...
        windowIds.forEach(function(_windowId){
            self.pavoApi.reloadWindow(_windowId);
        });
    }
}


module.exports = ReloadWindowsEventProcessor;
